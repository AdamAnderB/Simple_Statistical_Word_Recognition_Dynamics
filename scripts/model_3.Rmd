...
# - semantics: arbitrary list (meaning features, gloss)
...
lexicon_to_long <- function(lex) {
  ...
  # we'll use base R to avoid extra dependencies, but can swap to tibble/dplyr
...
# Noisy token lexicons (these are what is used in the model later)
